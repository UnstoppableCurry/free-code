...
function InvalidConfigDialog({
  ...
  return (
    <Dialog
      title={t('dialog.invalidConfig.title')}
      color="error"
      onCancel={onExit}
    >
      ...
      <Box flexDirection="column">
        <Text bold>{t('dialog.invalidConfig.chooseOption')}</Text>
        <Select
          options={[
            { label: t('dialog.invalidConfig.exit'), value: 'exit' },
            { label: t('dialog.invalidConfig.reset'), value: 'reset' },
          ]}

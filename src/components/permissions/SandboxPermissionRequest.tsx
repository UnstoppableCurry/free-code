...
export function SandboxPermissionRequest({
  ...
  const options = [
    { label: t('ui.permissions.sandbox.yes'), value: "yes" },
    ...(!managedDomainsOnly
      ? [
          {
            label: (
              <Text>
                {t('ui.permissions.sandbox.yesDontAskPrefix')}
                <Text bold>{host}</Text>
                {t('ui.permissions.sandbox.yesDontAskSuffix')}
              </Text>
            ),
      ...
      : []),
    {
      label: (
        <Text>
          {t('ui.permissions.sandbox.no')}{' '}
          <Text bold>{t('ui.permissions.sandbox.esc')}</Text>
        </Text>
      ),
      value: "no",
    },
  ...
  return (
    <PermissionDialog title={t('ui.permissions.sandbox.title')}>
      <Box flexDirection="column" paddingX={2} paddingY={1}>
        <Box>
          <Text dimColor>{t('ui.permissions.sandbox.host')}</Text>
          <Text> {host}</Text>
        </Box>
        <Box marginTop={1}>
          <Text>{t('ui.permissions.sandbox.allowConnection')}</Text>
        </Box>
        <Box>
          <Select
            options={options}
